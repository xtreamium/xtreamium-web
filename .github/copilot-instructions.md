...
When adding new components, please respect the colours in my site's css file and prefer using those colours over adding new ones to keep the design consistent.